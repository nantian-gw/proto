...
func (x *ExternalAuthConfig) Reset() {
	*x = ExternalAuthConfig{}
	mi := &file_gateway_control_v1_config_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalAuthConfig) Descriptor() ([]byte, []int) {
	return file_gateway_control_v1_config_proto_rawDescGZIP(), []int{44}
}
...
func (x *ExternalAuthHTTP) Reset() {
	*x = ExternalAuthHTTP{}
	mi := &file_gateway_control_v1_config_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalAuthHTTP) Descriptor() ([]byte, []int) {
	return file_gateway_control_v1_config_proto_rawDescGZIP(), []int{45}
}
...
func (x *ExternalAuthGRPC) Reset() {
	*x = ExternalAuthGRPC{}
	mi := &file_gateway_control_v1_config_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalAuthGRPC) Descriptor() ([]byte, []int) {
	return file_gateway_control_v1_config_proto_rawDescGZIP(), []int{46}
}
...
const file_gateway_control_v1_config_proto_rawDesc = "" +
	...
	"\n" +
	"slow_start\x18\x03 \x01(\v2#.gateway.control.v1.SlowStartConfigR\tslowStart\"\xf6\x04\n" +
	"\tGrpcRoute\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x1c\n" +
	"\thostnames\x18\x03 \x03(\tR\thostnames\x12>\n" +
	...
	"\x11outlier_detection\x18\x10 \x01(\v2*.gateway.control.v1.OutlierDetectionConfigR\x10outlierDetection\x12Q\n" +
...
var file_gateway_control_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_gateway_control_v1_config_proto_goTypes = []any{
	...
	(*HealthCheckConfig)(nil),         // 37: gateway.control.v1.HealthCheckConfig
	(*OutlierDetectionConfig)(nil),    // 38: gateway.control.v1.OutlierDetectionConfig
	(*SlowStartConfig)(nil),           // 39: gateway.control.v1.SlowStartConfig
	(*BackendEndpoint)(nil),           // 40: gateway.control.v1.BackendEndpoint
	(*HeaderMatch)(nil),               // 41: gateway.control.v1.HeaderMatch
	(*QueryMatch)(nil),                // 42: gateway.control.v1.QueryMatch
	(*Filter)(nil),                    // 43: gateway.control.v1.Filter
	(*SecretMaterial)(nil),            // 44: gateway.control.v1.SecretMaterial
	(*SecurityPolicyConfig)(nil),      // 45: gateway.control.v1.SecurityPolicyConfig
	(*SecurityAuthNConfig)(nil),       // 46: gateway.control.v1.SecurityAuthNConfig
	(*SecurityAuthZConfig)(nil),       // 47: gateway.control.v1.SecurityAuthZConfig
	(*SecurityCORSConfig)(nil),        // 48: gateway.control.v1.SecurityCORSConfig
	(*RateLimitRule)(nil),             // 49: gateway.control.v1.RateLimitRule
	(*SecurityIPConfig)(nil),          // 50: gateway.control.v1.SecurityIPConfig
	(*JwtAuthConfig)(nil),             // 51: gateway.control.v1.JwtAuthConfig
	(*JwtIssuer)(nil),                 // 52: gateway.control.v1.JwtIssuer
	(*OIDCConfig)(nil),                // 53: gateway.control.v1.OIDCConfig
	(*BasicAuthConfig)(nil),           // 54: gateway.control.v1.BasicAuthConfig
	(*ExternalAuthConfig)(nil),        // 55: gateway.control.v1.ExternalAuthConfig
	(*ExternalAuthHTTP)(nil),          // 56: gateway.control.v1.ExternalAuthHTTP
	(*ExternalAuthGRPC)(nil),          // 57: gateway.control.v1.ExternalAuthGRPC
	...
	nil,                               // 67: gateway.control.v1.JwtIssuer.ClaimsToHeadersEntry
	(*timestamppb.Timestamp)(nil),     // 68: google.protobuf.Timestamp
	(*structpb.Struct)(nil),           // 69: google.protobuf.Struct
	(*RoutePolicy)(nil),               // 70: gateway.control.v1.RoutePolicy
	(*durationpb.Duration)(nil),       // 71: google.protobuf.Duration
	(*AIServiceConfig)(nil),           // 72: gateway.control.v1.AIServiceConfig
	(*TokenPolicyConfig)(nil),         // 73: gateway.control.v1.TokenPolicyConfig
	(*WasmPluginConfig)(nil),          // 74: gateway.control.v1.WasmPluginConfig
}
var file_gateway_control_v1_config_proto_depIdxs = []int32{
	68,  // 0: gateway.control.v1.ConfigSnapshot.generated_at:type_name -> google.protobuf.Timestamp
	...
	44,  // 6: gateway.control.v1.ConfigSnapshot.secrets:type_name -> gateway.control.v1.SecretMaterial
	69,  // 7: gateway.control.v1.ConfigSnapshot.extensions:type_name -> google.protobuf.Struct
	...
	58,  // 10: gateway.control.v1.Listener.metadata:type_name -> gateway.control.v1.Listener.MetadataEntry
	15,  // 11: gateway.control.v1.Listener.backend_tls:type_name -> gateway.control.v1.BackendTlsConfig
	45,  // 12: gateway.control.v1.Listener.security_policy:type_name -> gateway.control.v1.SecurityPolicyConfig
	...
	59,  // 18: gateway.control.v1.HttpRoute.labels:type_name -> gateway.control.v1.HttpRoute.LabelsEntry
	60,  // 19: gateway.control.v1.HttpRoute.annotations:type_name -> gateway.control.v1.HttpRoute.AnnotationsEntry
	70,  // 20: gateway.control.v1.HttpRoute.route_policy:type_name -> gateway.control.v1.RoutePolicy
	45,  // 21: gateway.control.v1.HttpRoute.security_policy:type_name -> gateway.control.v1.SecurityPolicyConfig
	20,  // 22: gateway.control.v1.HttpRule.matches:type_name -> gateway.control.v1.HttpMatch
	43,  // 23: gateway.control.v1.HttpRule.filters:type_name -> gateway.control.v1.Filter
	...
	41,  // 28: gateway.control.v1.HttpMatch.headers:type_name -> gateway.control.v1.HeaderMatch
	42,  // 29: gateway.control.v1.HttpMatch.query_params:type_name -> gateway.control.v1.QueryMatch
	71,  // 30: gateway.control.v1.HttpRouteTimeouts.request:type_name -> google.protobuf.Duration
	71,  // 31: gateway.control.v1.HttpRouteTimeouts.backend_request:type_name -> google.protobuf.Duration
	71,  // 32: gateway.control.v1.HttpRouteRetry.backoff:type_name -> google.protobuf.Duration
	5,   // 33: gateway.control.v1.CookieConfig.lifetime_type:type_name -> gateway.control.v1.CookieLifetimeType
	71,  // 34: gateway.control.v1.SessionPersistence.absolute_timeout:type_name -> google.protobuf.Duration
	71,  // 35: gateway.control.v1.SessionPersistence.idle_timeout:type_name -> google.protobuf.Duration
	...
	39,  // 41: gateway.control.v1.LoadBalancingPolicy.slow_start:type_name -> gateway.control.v1.SlowStartConfig
	33,  // 42: gateway.control.v1.GrpcRoute.parent_refs:type_name -> gateway.control.v1.ParentRef
	28,  // 43: gateway.control.v1.GrpcRoute.rules:type_name -> gateway.control.v1.GrpcRule
	61,  // 44: gateway.control.v1.GrpcRoute.labels:type_name -> gateway.control.v1.GrpcRoute.LabelsEntry
	62,  // 45: gateway.control.v1.GrpcRoute.annotations:type_name -> gateway.control.v1.GrpcRoute.AnnotationsEntry
	70,  // 46: gateway.control.v1.GrpcRoute.route_policy:type_name -> gateway.control.v1.RoutePolicy
	45,  // 47: gateway.control.v1.GrpcRoute.security_policy:type_name -> gateway.control.v1.SecurityPolicyConfig
	29,  // 48: gateway.control.v1.GrpcRule.matches:type_name -> gateway.control.v1.GrpcMatch
	43,  // 49: gateway.control.v1.GrpcRule.filters:type_name -> gateway.control.v1.Filter
	34,  // 50: gateway.control.v1.GrpcRule.backend_refs:type_name -> gateway.control.v1.BackendRef
	24,  // 51: gateway.control.v1.GrpcRule.session_persistence:type_name -> gateway.control.v1.SessionPersistence
	41,  // 52: gateway.control.v1.GrpcMatch.headers:type_name -> gateway.control.v1.HeaderMatch
	2,   // 53: gateway.control.v1.StreamRoute.kind:type_name -> gateway.control.v1.RouteKind
	33,  // 54: gateway.control.v1.StreamRoute.parent_refs:type_name -> gateway.control.v1.ParentRef
	31,  // 55: gateway.control.v1.StreamRoute.rules:type_name -> gateway.control.v1.StreamRule
	63,  // 56: gateway.control.v1.StreamRoute.labels:type_name -> gateway.control.v1.StreamRoute.LabelsEntry
	64,  // 57: gateway.control.v1.StreamRoute.annotations:type_name -> gateway.control.v1.StreamRoute.AnnotationsEntry
	32,  // 58: gateway.control.v1.StreamRule.matches:type_name -> gateway.control.v1.StreamMatch
	34,  // 59: gateway.control.v1.StreamRule.backend_refs:type_name -> gateway.control.v1.BackendRef
	1,   // 60: gateway.control.v1.StreamMatch.mode:type_name -> gateway.control.v1.TlsRouteMode
	65,  // 61: gateway.control.v1.BackendRef.metadata:type_name -> gateway.control.v1.BackendRef.MetadataEntry
	43,  // 62: gateway.control.v1.BackendRef.filters:type_name -> gateway.control.v1.Filter
	40,  // 63: gateway.control.v1.BackendCluster.endpoints:type_name -> gateway.control.v1.BackendEndpoint
	71,  // 64: gateway.control.v1.BackendCluster.connect_timeout:type_name -> google.protobuf.Duration
	71,  // 65: gateway.control.v1.BackendCluster.request_timeout:type_name -> google.protobuf.Duration
	66,  // 66: gateway.control.v1.BackendCluster.metadata:type_name -> gateway.control.v1.BackendCluster.MetadataEntry
	16,  // 67: gateway.control.v1.BackendCluster.tls_validation:type_name -> gateway.control.v1.BackendTlsValidation
	24,  // 68: gateway.control.v1.BackendCluster.session_persistence:type_name -> gateway.control.v1.SessionPersistence
	26,  // 69: gateway.control.v1.BackendCluster.load_balancing:type_name -> gateway.control.v1.LoadBalancingPolicy
	72,  // 70: gateway.control.v1.BackendCluster.ai_service:type_name -> gateway.control.v1.AIServiceConfig
	73,  // 71: gateway.control.v1.BackendCluster.token_policy:type_name -> gateway.control.v1.TokenPolicyConfig
	74,  // 72: gateway.control.v1.BackendCluster.wasm_plugin:type_name -> gateway.control.v1.WasmPluginConfig
	36,  // 73: gateway.control.v1.BackendCluster.circuit_breaker:type_name -> gateway.control.v1.CircuitBreakerConfig
	37,  // 74: gateway.control.v1.BackendCluster.health_check:type_name -> gateway.control.v1.HealthCheckConfig
	38,  // 75: gateway.control.v1.BackendCluster.outlier_detection:type_name -> gateway.control.v1.OutlierDetectionConfig
	45,  // 76: gateway.control.v1.BackendCluster.security_policy:type_name -> gateway.control.v1.SecurityPolicyConfig
	71,  // 77: gateway.control.v1.HealthCheckConfig.interval:type_name -> google.protobuf.Duration
	71,  // 78: gateway.control.v1.HealthCheckConfig.timeout:type_name -> google.protobuf.Duration
	71,  // 79: gateway.control.v1.OutlierDetectionConfig.interval:type_name -> google.protobuf.Duration
	71,  // 80: gateway.control.v1.OutlierDetectionConfig.base_ejection_time:type_name -> google.protobuf.Duration
	71,  // 81: gateway.control.v1.SlowStartConfig.window:type_name -> google.protobuf.Duration
	69,  // 82: gateway.control.v1.Filter.config:type_name -> google.protobuf.Struct
	46,  // 83: gateway.control.v1.SecurityPolicyConfig.authn:type_name -> gateway.control.v1.SecurityAuthNConfig
	47,  // 84: gateway.control.v1.SecurityPolicyConfig.authz:type_name -> gateway.control.v1.SecurityAuthZConfig
	48,  // 85: gateway.control.v1.SecurityPolicyConfig.cors:type_name -> gateway.control.v1.SecurityCORSConfig
	49,  // 86: gateway.control.v1.SecurityPolicyConfig.rate_limit:type_name -> gateway.control.v1.RateLimitRule
	50,  // 87: gateway.control.v1.SecurityPolicyConfig.ip:type_name -> gateway.control.v1.SecurityIPConfig
	51,  // 88: gateway.control.v1.SecurityAuthNConfig.jwt:type_name -> gateway.control.v1.JwtAuthConfig
	53,  // 89: gateway.control.v1.SecurityAuthNConfig.oidc:type_name -> gateway.control.v1.OIDCConfig
	54,  // 90: gateway.control.v1.SecurityAuthNConfig.basic_auth:type_name -> gateway.control.v1.BasicAuthConfig
	55,  // 91: gateway.control.v1.SecurityAuthZConfig.external:type_name -> gateway.control.v1.ExternalAuthConfig
	8,   // 92: gateway.control.v1.RateLimitRule.scope:type_name -> gateway.control.v1.RateLimitScope
	9,   // 93: gateway.control.v1.RateLimitRule.on_limit:type_name -> gateway.control.v1.RateLimitAction
	52,  // 94: gateway.control.v1.JwtAuthConfig.issuers:type_name -> gateway.control.v1.JwtIssuer
	67,  // 95: gateway.control.v1.JwtIssuer.claims_to_headers:type_name -> gateway.control.v1.JwtIssuer.ClaimsToHeadersEntry
	10,  // 96: gateway.control.v1.ExternalAuthConfig.protocol:type_name -> gateway.control.v1.ExternalAuthTransport
	34,  // 97: gateway.control.v1.ExternalAuthConfig.backend_ref:type_name -> gateway.control.v1.BackendRef
	56,  // 98: gateway.control.v1.ExternalAuthConfig.http:type_name -> gateway.control.v1.ExternalAuthHTTP
	57,  // 99: gateway.control.v1.ExternalAuthConfig.grpc:type_name -> gateway.control.v1.ExternalAuthGRPC
